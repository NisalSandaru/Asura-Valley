 ...
 * @author User
 */
public class SelectActivity extends javax.swing.JDialog {

    private AddBooking ab;
    public SelectActivity(java.awt.Frame parent, boolean modal, AddBooking ab) {
        super(parent, modal);
        initComponents();
        this.ab = ab;
        loadActivity();
            ...
            if (row != -1) {
                ...
                if (resultSet.next()) {
                    ...
                    if (evt.getClickCount() == 2) {
                        if (ab != null) {
                            ab.getjTextField1().setText(String.valueOf(jTable1.getValueAt(row, 1)));
                            ab.getjFormattedTextField1().setText(String.valueOf(jTable1.getValueAt(row, 2)));
                            ab.getjLabel9().setText(String.valueOf(jTable1.getValueAt(row, 0)));
                            this.dispose();
                        }
                    }
