...
public class SelectCustomer extends javax.swing.JDialog {
    ...
    public SelectCustomer(java.awt.Frame parent, boolean modal, AddBooking ab) {
        super(parent, modal);
        this.ab = ab;
        initComponents();
        loadCus();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Double Click to select Customer");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer Mobile", "Customer First Name", "Customer Last Name"
            }
        ) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            if (ab != null) {
                ab.getjTextField2().setText(String.valueOf(jTable1.getValueAt(row, 1)));
                ab.getjTextField4().setText(String.valueOf(jTable1.getValueAt(row, 0)));
                this.dispose();
            }
        }
