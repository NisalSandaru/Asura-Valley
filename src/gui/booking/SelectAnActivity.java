 ...
 * @author User
 */
public class SelectAnActivity extends javax.swing.JDialog {

    private ManageBooking mb;
    public SelectAnActivity(java.awt.Frame parent, boolean modal, ManageBooking mb) {
        super(parent, modal);
        this.mb = mb;
        initComponents();
        loadActivity();
                ...
                if (resultSet.next()) {
                    ...
                    if (evt.getClickCount() == 2) {
                        if (mb != null) {
                            ...
                            mb.getjLabel10().setText(String.valueOf(jTable1.getValueAt(row, 0)));
                            this.dispose();
                        }
                    }
