 ...
 * @author User
 */
public class SelectInActivity extends javax.swing.JDialog {

    private InvoicePanel in;
    public SelectInActivity(java.awt.Frame parent, boolean modal, InvoicePanel in) {
        super(parent, modal);
        this.in = in;
        initComponents();
        loadActivity();
            ...
            if (row != -1) {
                ...
                if (resultSet.next()) {
                    ...
                    if (evt.getClickCount() == 2) {
                        if (in != null) {
                            in.getjTextField1().setText(String.valueOf(jTable1.getValueAt(row, 1)));
                            in.getjLabel9().setText(String.valueOf(jTable1.getValueAt(row, 0)));
                            this.dispose();
                        }
                    }
