 ...
 * @author User
 */
public class MonthlyIncome extends javax.swing.JDialog {

    /**
     * Creates new form DailyIncome
     */
    public MonthlyIncome(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadTable();
    }
    ...
    private void loadTable() {
        try {
            ...
            ResultSet resultSet = MySQL2.executeSearch("SELECT * FROM `invoice` INNER JOIN `bookings` ON `bookings`.`id` = `invoice`.`bookings_id` INNER JOIN `customer` ON "
                    + "`customer`.`mobile` = `bookings`.`customer_mobile` WHERE MONTH(`invoice`.`date`) = " + currentMonth + " AND YEAR(`invoice`.`date`) = " + currentYear);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            params.put("Parameter4", "Monthly Income Report");
            params.put("Parameter5", "Monthly Income :");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MonthlyIncome dialog = new MonthlyIncome(new javax.swing.JFrame(), true);
