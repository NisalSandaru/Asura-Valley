...
import gui.customer.AllCustomer;
import gui.employee.AllEmployee;
import gui.superAdmin.AttendanceReport;
...
public class ReportOptions extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/icons8-report-50.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        MonthlyIncome mi = new MonthlyIncome((Frame) javax.swing.SwingUtilities.getWindowAncestor(this), true);
        mi.setVisible(true);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        DailyIncome di = new DailyIncome((Frame) javax.swing.SwingUtilities.getWindowAncestor(this), true);
        di.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        AllCustomer ac = new AllCustomer((Frame) javax.swing.SwingUtilities.getWindowAncestor(this), true);
        ac.setVisible(true);
